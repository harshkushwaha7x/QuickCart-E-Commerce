        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="lg:pr-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-blue-600 text-white py-3 px-6 rounded-lg font-medium hover:bg-blue-700 transition duration-200 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
              >
                Send Message
              </button>
            </form>
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">+91 8528815252</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">harshkushwaha4151@gmail.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Cyber City, Gurugram<br />Haryana, India 122002</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-blue-50 rounded-lg p-6">
                ...
                <div className="space-y-3">
                  <div>
                    <p className="font-medium text-gray-900 text-sm">Order Issues?</p>
                    <p className="text-gray-600 text-sm">Check your order status in "My Orders" section</p>
                  </div>
                  <div>
                    <p className="font-medium text-gray-900 text-sm">Return & Refund?</p>
                    <p className="text-gray-600 text-sm">We offer 10-day hassle-free returns</p>
                  </div>
                  <div>
                    <p className="font-medium text-gray-900 text-sm">Technical Support?</p>
                    <p className="text-gray-600 text-sm">Our tech team is available 24/7</p>
                  </div>
                </div>
              </div>
            </div>
